...
const pkmnIds1 = pokémon.filter( p => p.id%3 === 0 );
console.log(pkmnIds1);
console.log("***************************************************");
...
const pkmnPoison = pokémon.filter( p => p.types.includes("poison") && p.types.length==1).map( p => p.name);
...
console.log("Counts = " ,pkmnNormal.length);
console.log("***************************************************");